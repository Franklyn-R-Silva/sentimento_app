...
3. **Interface Responsiva (Textos)**: Para evitar erros de overflow e garantir que o layout se adapte a diferentes tamanhos de tela e configurações de acessibilidade, **deve-se utilizar o widget `AutoSizeText` em vez do `Text` padrão** em elementos da interface onde o conteúdo pode variar de tamanho ou o espaço é limitado.
4. **Testes**: Todos os novos componentes devem ter testes de widget. Lógica de negócios complexa deve ter testes unitários.
