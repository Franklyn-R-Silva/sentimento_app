    ...
    case FormatType.decimal:
      switch (decimalType!) {
        ...
        case DecimalType.commaDecimal:
          if (currency != null) {
            formattedValue = NumberFormat('#,##0.00', 'pt_BR').format(value);
          } else {
...
extension FFStringExt on String {
  ...
  String toCapitalization(final TextCapitalization textCapitalization) {
...
String getCurrentRoute(final BuildContext context) =>
    context.mounted ? MyApp.of(context).getRoute() : '';
List<String> getCurrentRouteStack(final BuildContext context) =>
